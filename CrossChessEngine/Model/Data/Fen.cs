...
namespace CrossChessEngine.Model.Data
{
    public static class Fen
    {
        ...
        public static void SetBoardPosition(string fenString)
        {
            ...
            // White King's Rook
            if ((pieceRook = Board.GetPiece(7, 0)) != null && pieceRook.Name == PieceModel.PieceNames.Rook
            ...
            // Black King's Rook
            if ((pieceRook = Board.GetPiece(7, 7)) != null && pieceRook.Name == PieceModel.PieceNames.Rook
            ...
            // White Queen's Rook
            if ((pieceRook = Board.GetPiece(0, 0)) != null && pieceRook.Name == PieceModel.PieceNames.Rook
                && pieceRook.Player.Colour == Player.PlayerColourNames.White)
            {
            ...
            // Black Queen's Rook
            if ((pieceRook = Board.GetPiece(0, 7)) != null && pieceRook.Name == PieceModel.PieceNames.Rook
                && pieceRook.Player.Colour == Player.PlayerColourNames.Black)
            {
                pieceRook.NoOfMoves = strCastlingRights.LastIndexOf("q") >= 0 ? 0 : 1;
            }
        ...
        {
            if ((Game.MoveHistory.Count > 0) && (Game.MoveHistory.Last.Piece.Name == PieceModel.PieceNames.Pawn)
        ...
        {
            PieceModel.PieceNames piecename = PieceModel.PieceNames.King;
            ...
            {
                case "K":
                    piecename = PieceModel.PieceNames.King;
                    break;
                case "Q":
                    piecename = PieceModel.PieceNames.Queen;
                    break;
                case "R":
                    piecename = PieceModel.PieceNames.Rook;
                    break;
                case "B":
                    piecename = PieceModel.PieceNames.Bishop;
                    break;
                case "N":
                    piecename = PieceModel.PieceNames.Knight;
                    break;
                case "P":
                    piecename = PieceModel.PieceNames.Pawn;
                    break;
            }
            ...
            {
                if ((pieceCaptured.Name == piecename || (blnAllowPromotion && pieceCaptured.Name == PieceModel.PieceNames.Pawn))
