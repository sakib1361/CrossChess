...
namespace CrossChessEngine.Model.Data
{
    public abstract class Player
    {
        ...
        protected Player()
        {
            ...
            this._PieceTypes = new List<PieceModel.PieceNames>();
        ...
        private readonly List<PieceNames> _PieceTypes;
        ...
        public bool CanClaimInsufficientMaterialDraw
        {
            get
            {
                ...
                Piece pieceNotKing = playerTwoPieces.Pieces.Item(0).Name == PieceModel.PieceNames.King
                                         ? playerTwoPieces.Pieces.Item(1)
                                         : playerTwoPieces.Pieces.Item(0);

                switch (pieceNotKing.Name)
                {
                    case PieceModel.PieceNames.Bishop:
                    case PieceModel.PieceNames.Knight:
                        return true;
                }
        ...
        public List<PieceModel.PieceNames> PieceTypes()
        {
        ...
        public int PositionPoints
        {
            get
            {
                ...
                for (int intIndex = this.Pieces.Count - 1; intIndex >= 0; intIndex--)
                {
                    ...
                    if (piece.Name != PieceModel.PieceNames.Pawn)
                    {
                        ...
                        switch (piece.Name)
                        {
                            ...
                            case PieceModel.PieceNames.Rook:
                                intRookCount++;
                                break;
                        }
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (pieceRook == null || pieceRook.Name != PieceModel.PieceNames.Rook
        ...
        public bool CanClaimMoveRepetitionDraw(int numberOfMoves)
        {
            ...
            for (; intIndex >= 0; intIndex--, intIndex--)
            {
                ...
                if (move.Piece.Name == PieceModel.PieceNames.Pawn || move.PieceCaptured != null)
                {
                    return false;
                }
            }
        ...
        /// </returns>
        public bool HasPieceName(PieceModel.PieceNames piecename)
        {
            if (piecename == PieceModel.PieceNames.Pawn && this.PawnCountInPlay > 0)
            {
                return true;
            }
