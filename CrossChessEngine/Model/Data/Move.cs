...
namespace CrossChessEngine.Model.Data
{
    public class Move : IComparable
    {
        ...
        public Move(int turnNo, int lastMoveTurnNo, MoveNames moveName, Piece piece, Square from, Square to, Piece pieceCaptured, int pieceCapturedOrdinal, int score)
        {
            ...
            this.Score = score;
            if (moveName != MoveNames.NullMove && pieceCaptured == null && piece != null && piece.Name != PieceNames.Pawn)
            {
        ...
        public string Description
        {
            get
            {
                ...
                switch (this.Name)
                {
                    ...
                    default:
                        if ((this.Piece.Name != PieceNames.Pawn) && !this.Piece.HasBeenPromoted)
                        {
                        ...
                        {
                            strbMove.Append("x");
                            if (this.PieceCaptured.Name != PieceNames.Pawn)
                            {
        ...
        public static void Undo(Move move)
        {
            ...
            if (move.Piece.Name == PieceNames.Pawn)
            {
            ...
            if (move.PieceCaptured != null)
            {
                ...
                if (move.PieceCaptured.Name == PieceNames.Pawn)
                {
            ...
            if (move.From.Piece.Name == PieceNames.Pawn)
            {
