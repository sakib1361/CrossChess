...
namespace CrossChessEngine.Model.Data
{
    public static class Board
    {
        ...
        public static Piece LinesFirstPiece(
            Player.PlayerColourNames colour, PieceModel.PieceNames pieceName, Square squareStart, int vectorOffset)
        {
            int intOrdinal = squareStart.Ordinal;
            Square square;
        ...
        public static int OpenLinePenalty(Player.PlayerColourNames colour, Square squareStart, int directionOffset)
        {
            ...
            while (intSquareCount <= 2
                   ...
                   ((square = GetSquare(intOrdinal)) != null
                    &&
                    (square.Piece == null
                     || (square.Piece.Name != PieceNames.Pawn && square.Piece.Name != PieceNames.Rook)
