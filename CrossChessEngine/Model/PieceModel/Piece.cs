...
{
    public partial class Piece : IPieceTop
    {
        ...
        /// <returns></returns>
        public static bool CanPlayerPieceNameAttackSquare(Square square, Player player, PieceNames PieceName)
        {
            switch (PieceName)
            {
                case PieceNames.Bishop:
        ...
        public static bool CanPlayerPieceNameAttackSquare(Square square, Player player, PieceNames PieceName, out Piece attackingPiece)
        {
            attackingPiece = null;
            switch (PieceName)
            {
        ...
        public Move Move(Move.MoveNames moveName, Square square)
        {
            ...
            if (moveName == Data.Move.MoveNames.EnPassent)
            {
            ...
            switch (moveName)
            {
                case Data.Move.MoveNames.CastleKingSide:
                ...
                case Data.Move.MoveNames.CastleQueenSide:
                    pieceRook = move.Piece.Player.Colour == Player.PlayerColourNames.White
                                    ? Board.GetPiece(0, 0)
                                    : Board.GetPiece(0, 7);
                    Board.HashCodeA ^= pieceRook.HashCodeA;
                ...
                case Data.Move.MoveNames.PawnPromotionQueen:
                    this.Promote(PieceNames.Queen);
                    break;

                case Data.Move.MoveNames.PawnPromotionRook:
                    this.Promote(PieceNames.Rook);
                    break;

                case Data.Move.MoveNames.PawnPromotionBishop:
                    this.Promote(PieceNames.Bishop);
                    break;

                case Data.Move.MoveNames.PawnPromotionKnight:
                    this.Promote(PieceNames.Knight);
                    break;

                case Data.Move.MoveNames.EnPassent:
